...
const ProjectDetailsForm: React.FC<ProjectDetailsFormProps> = ({
  ...
  React.useEffect(() => {
    ...
    setProjectData({
      ...
      special_instructions: "This should be a realistic documentary, with a lot of details and explanations, this is told from the perspective of the narrator. So all the scenes should be told from the perspective of the narrator and the narration text should be in the first person perspective.",
...
Downstairs
  ...
  
  
   Indicates entrance doors
   Indicates small little wall
...
Upstairs
  ...
  
  
   The hidden light switch behind the wooden beam construction
